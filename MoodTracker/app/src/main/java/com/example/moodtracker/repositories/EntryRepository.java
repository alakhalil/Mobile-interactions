...
public class EntryRepository {
    ...
    private void setEntries() {
        int[] imageId = {R.drawable.emoticon_sad_btn, R.drawable.emoticon_energetic_btn
        ...
        String[] feeling_description = {"Feeling sad", "Feeling energetic", "Feeling depressed", "Feeling hyperactive", "Feeling neutral"};
